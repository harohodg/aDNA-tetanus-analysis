...
#   Cdiff plasmid sequence across the 38 BioSamples

message("Running plotCoverage-plasmid.R v1")
message("---------------------------------")
message("")

print_usage <- function() {
  message("Usage:    plotCoverage-plasmid --gff=file.gff --bam=bamFolder/ [optional args]")
  message("")
...
for (i in seq_along(bam)) {
  circos.genomicTrack(bam[[i]], track.height = cov_height,
    ...
    panel.fun = function(region, value, ...) {
      ...
      if (i == 4) {
        circos.text(74081 + convert_x(3, "mm"), 1, 35, cex = 0.9,
          facing = "downward", adj = c(0, 0.7))
      }
      if (i == 9) {
        circos.text(74081 + convert_x(3, "mm"), 1, 30, cex = 0.9,
          facing = "downward", adj = c(0, 0.7))
      }
      if (i == 14) {
        circos.text(74081 + convert_x(3, "mm"), 1, 25, cex = 0.9,
          facing = "downward", adj = c(0, 0.6))
      }
      if (i == 19) {
        circos.text(74081 + convert_x(3, "mm"), 1, 20, cex = 0.9,
          facing = "downward", adj = c(0, 0.6))
      }
      if (i == 24) {
        circos.text(74081 + convert_x(2.5, "mm"), 1, 15, cex = 0.9,
          facing = "downward", adj = c(0, 0.6))
      }
      if (i == 29) {
        circos.text(74081 + convert_x(2.5, "mm"), 1, 10, cex = 0.9,
          facing = "downward", adj = c(0, 0.6))
      }
      if (i == 34) {
        circos.text(74081 + convert_x(3, "mm"), 1, 5, cex = 0.9,
          facing = "downward", adj = c(0, 0.5))
      }
      circos.text(74081 + 100, 1, "-", cex = 0.8,
        facing = "downward", adj = c(0, 0.7))
